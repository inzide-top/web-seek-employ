...
export const chinaCities: ProvinceCityOption[] = [
  { name: '热门', cities: ['北京', '上海', '广州', '深圳', '杭州', '成都', '南京', '苏州', '武汉', '西安'] },
  ...
  { name: '海南', cities: ['海口', '三亚', '三沙', '儋州', '五指山', '琼海', '文昌', '万宁', '东方'] },
  {
    name: '四川',
    cities: [
      '成都',
  ...
  { name: '港澳台', cities: ['香港', '澳门', '台北', '新北', '桃园', '台中', '台南', '高雄'] },
  { name: '海外/远程', cities: ['远程', '海外'] },
]
