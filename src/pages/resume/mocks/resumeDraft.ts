...
export const mockResumeDraft: ResumeDraft = {
  ...
  workExperiences: [
    {
      id: 'c5fa377f-f838-4e83-a481-5ad152d115d9',
      companyName: '作业帮',
      industry: '在线教育',
      department: '中台产业中心',
      jobTitle: '前端开发工程师',
    ...
    {
      id: '93a970f2-5f98-4427-98f6-4da0a7900da0',
      companyName: '思为科技',
      industry: '企业服务/软件服务',
      department: '应用开发部',
      jobTitle: '前端开发工程师',
  ...
  projects: [
    ...
    },
    {
      ...
      content:
        '1. 完成接待统计模块开发：使用antv框架以及echarts提供数据可视化功能（折线图、饼图、柱状图、词云图等），为客户团队提供直观的案场数据概览、顾客标签分布、销售接待状况评估等关键指标可视化，显著提升数据洞察效率与业务决策支持能力；精准展示客户认可以及抗性点分布，助力销售策略优化。 \n2. 参与接待详情模块迭代：实现实时案场录音播放与对话记录同步滚动，提升销售复盘效率与质量；协助后端集成 ChatGPT 大模型提供自动化接待总结与建议，以及利用 SSE 技术实现私有化 LLM 问答对话，帮助客户销售团队快速提炼关键信息并改进话术。 \n3. 维护微前端架构以及iframe通信服务：有效解决跨系统通信中出现的兼容性问题，提升项目可靠与稳定性，保障数据统计模块的正常运行。',
      outcomes: '',
    },
    {
      ...
      content:
        '1. 优化状态管理与接口封装：对axios二次封装，并优化pinia提升用户身份（顾问与管理员）切换体验，实现全局筛选状态的存储与复用。 \n2. 开发数据统计模块：基于用户身份展示客户画像与销讲分析，灵活切换Echarts数据图表（饼图、柱状图、词云等），提供直观数据洞察。 \n3. 维护接待列表模块：实现录音播放与对话记录同步，协助集成AI语言模型提供总结与问答，确保后台体验统一。 \n4. 开发工牌报表模块：实现支持大量数据的多维排序表格，并参与Nuxt.js实现服务端渲染静态报表工作，便于案场管理员保存与分享，提升客户工作效率。 \n5. 协助集成埋点监控 & Sentry 平台：实时捕获生产环境问题，通过飞书机器人报警，有效保障系统稳定运行，节约排查故障时间。',
      outcomes: '',
    },
    {
